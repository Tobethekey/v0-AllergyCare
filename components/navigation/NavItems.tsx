...
const navLinks = [
  ...
  { href: "/ai-chat", label: "AI-Chat", icon: MessageCircle, premiumOnly: true },
  ...
  return (
    <nav className="flex flex-col gap-1 p-2">
      ...
      {navLinks.map((link) => {
        ...
        const isPremiumOnlyLink = link.premiumOnly && !premiumStatus.isPremium

        if (link.premiumOnly && !premiumStatus.isPremium) {
          return null
        }
